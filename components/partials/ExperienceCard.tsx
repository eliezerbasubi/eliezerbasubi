  ...
  return (
    <div className={`${isLeft ? 'flex justify-end' : ''} ${className}`}>
      <div className="relative flex md:w-full lg:w-1/2">
        ...
        <div className="w-full lg:w-[420px] xl:w-[465px] 5xl:w-[600px] min-h-[237px] bg-white border border-gray-300 rounded-2xl p-4 5xl:p-6 flex-shrink-0">
          <div className="flex justify-between flex-wrap lg:flex-nowrap">
            <div className="flex-initial">
              ...
              <p className="text-sm md:text-sm 5xl:text-xl 5xl:leading-none 5xl:mt-2 leading-[17px] tracking-75 text-black/75">
                {experience.company}
              </p>
            </div>
            <p className="text-xs md:text-sm 5xl:text-xl text-gray-500 md:leading-10 tracking-75 self-start">
          ...
          <div className="py-4">
            {experience.duties.map((duty, index) => (
              <div className="flex space-x-2 mb-3" key={index.toFixed()}>
                ...
                <p className="text-xs 2xl:text-sm 5xl:text-xl 5xl:tracking-normal tracking-75 2xl:tracking-wide font-normal">
                  {duty}
                </p>
              </div>
            ))}
