    ...
    <div className="relative">
      <div className="md:absolute container mx-auto bg-black md:bg-transparent z-10 pb-16 md:pb-0 min-h-screen">
        ...
        <div className="text-white py-6 md:py-12 px-8 pt-3 lg:px-12 ml:px-24">
          ...
          <div className="hidden md:flex items-center space-x-20 mt-28 lg:mt-8 xl:mt-16 ml:mt-28 2xl:mt-36 absolute text-xl 2xl:text-2xl tracking-75 font-medium">
            <div>Experience</div>
            <div>Skills</div>
            <div>Work</div>
            <div>Contact</div>
        ...
        <div className="flex flex-col justify-center items-center md:block md:absolute lg:left-[42rem] ml:left-[940px] xl:left-[56rem] 3xl:left-[66rem] 4xl:left-[79rem] lg:top-[14rem] ml:top-[316px] xl:top-[19rem] 3xl:top-[22rem] 4xl:top-[26rem]">
